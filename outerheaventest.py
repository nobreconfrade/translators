...
session.run("CREATE (%s:Producer {label:{label},datex:{datex},comment:{comment}})"%producer,{"label":label,"datex":datex,"comment":comment})
...
session.run("CREATE (%s:Product {label:{label},datex:{datex},comment:{comment},propertyNumeric1:{propertyNumeric1},"
"propertyNumeric2:{propertyNumeric2},propertyNumeric3:{propertyNumeric3},propertyText1:{propertyText1},"
"propertyText2:{propertyText2},propertyText3:{propertyText3}})"%product, {"label":label,"datex": datex, "comment":comment,
...
session.run("CREATE ("+producer+") -[:"+relation+"]-> ("+product+")")
