...
session.run("CREATE (producer1:Producer {label:{label},datex:{datex},comment:{comment}})",{"label":label,"datex":datex,"comment":comment})
...
session.run("CREATE (product1:Product {label:{label},datex:{datex},comment:{comment},propertyNumeric1:{propertyNumeric1},"
"propertyNumeric2:{propertyNumeric2},propertyNumeric3:{propertyNumeric3},propertyText1:{propertyText1},"
"propertyText2:{propertyText2},propertyText3:{propertyText3}})", {"label":label,"datex": datex, "comment":comment,
...
session.run("CREATE (product1) -[:producer]-> (producer1)")#,{"product":product, "relation":relation, "producer":producer})
